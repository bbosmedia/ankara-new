    ...
    <nav aria-label="breadcrumb">
      <ol className="breadcrumb ya-breadcrumb">
        <li className="breadcrumb-item">
            {lang === '' && <Link to="/" className="nuxt-link-active"> Главная </Link>}
            {lang === '/uz' && <Link to="/uz" className="nuxt-link-active"> Bosh Sahifa </Link>}
            {lang === '/en' && <Link to="/en" className="nuxt-link-active"> Home</Link>}
        </li>
        <li className="breadcrumb-item">
            {lang === '' && <Link to="/restaurants" className="nuxt-link-active"> Рестораны </Link>}
            {lang === '/uz' && <Link to="/uz/restaurants" className="nuxt-link-active"> Restoranlar</Link>}
            {lang === '/ru' && <Link to="/ru/restaurants" className="nuxt-link-active"> Restaurants </Link>}
        </li>
        <li aria-current="page" className="breadcrumb-item active"> Yaponamama Шота </li>
      </ol>
    </nav>
    {lang === '' && <h1 className="ya-group-title">О ресторане</h1>}
    {lang === '/uz' && <h1 className="ya-group-title">Restoran haqida</h1>}
    {lang === '/en' && <h1 className="ya-group-title">About restaurant</h1>}
    <div className="row">
      <div className="col-md-8">
        <div className="ya-restaurant-text">
          ...
          <p><strong>Резерв столов:</strong>&nbsp; <a href="tel:+998982511213">+99898-251-12-13</a>; <a href="tel:+998712531213">+99871-253-12-13</a></p>
