...
const GalleryItemBreadcrumb = ({ lang, titleUz, titleRu, titleEn }) => {
  if (lang === "/uz") {
    return (
      <>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb ya-breadcrumb">
            ...
            <li className="breadcrumb-item">
              <Link to="/uz/gallery" className="nuxt-link-active">
                Galereya
              </Link>
            </li>
      ...
      <>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb ya-breadcrumb">
            ...
            <li className="breadcrumb-item">
              <Link to="/en/gallery" className="nuxt-link-active">
                Gallery
              </Link>
            </li>
            <li aria-current="page" className="breadcrumb-item active">
      ...
      <>
        <nav aria-label="breadcrumb">
          <ol className="breadcrumb ya-breadcrumb">
            ...
            <li className="breadcrumb-item">
              <Link to="/gallery" className="nuxt-link-active">
                Галерея
              </Link>
            </li>
            <li aria-current="page" className="breadcrumb-item active">
...
export default GalleryItemBreadcrumb;
