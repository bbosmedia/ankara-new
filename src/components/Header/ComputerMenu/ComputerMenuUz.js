    ...
    return (
        <nav className='navbar navbar-expand-lg navbar-light ya-nav'>
            <div className="container-fluid">
                <Link to="/uz" aria-current="page" title="Yaponamama" className="navbar-brand nuxt-link-exact-active nuxt-link-active">
                ...
                <div className="collapse navbar-collapse">
                    <div className="navbar-nav ya-navbar align-items-center mr-auto">
                        <a aria-current="page" className="nav-item nav-link ya-city-link nuxt-link-exact-active nuxt-link-active" role="button">Toshkent</a>
                    </div>
                    ...
                    <div className="navbar-nav ya-opt-navbar align-items-center mr-0">
                        <a aria-current="page" className="nav-item nav-link ya-lang nuxt-link-exact-active nuxt-link-active ya-uz" role="button">O'zbek</a>
