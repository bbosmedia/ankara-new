...
const ComputerMenuRu = ({langModel, changeComputerMenu, openCartMenu, changeLogin, accessToken}) => {
        ...
        <div className="collapse navbar-collapse">
          ...
          <div className="navbar-nav ya-opt-navbar align-items-center mr-0">
            <a
             onClick={langModel}
              aria-current="page"
              className="nav-item nav-link ya-lang nuxt-link-exact-active nuxt-link-active ya-ru"
              role="button"
            >
              Русский
            </a>
            ...
            {accessToken.length > 0 && <Link to='/uz/profile'
              aria-current="page"
              className="nav-item nav-link border-left-0 pt-0 pb-0 nuxt-link-exact-active nuxt-link-active"
              role="button"
            >
